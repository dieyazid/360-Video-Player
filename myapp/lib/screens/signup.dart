    ...
    return Scaffold(
        ...
        Stack(
              children:[
                Positioned(
                  ...
                  child: Image.asset(
                  "images/splash1.png",width: size.width*0.3,),
                ),
                Positioned(
      ...
      Column(
        children: [
          ...
          Center(child: 
          Image.asset("images/login.png",height: size.height*0.3,)),
        Center(
        child: Text(
          "Sign Up",
      ...
      Center(
        child:SizedBox(
          ...
          prefixIcon: const Icon(Icons.person, size: 24,color: color_blue,),
      ...
      Center(
        child:SizedBox(
          ...
          prefixIcon: const Icon(Icons.mail, size: 24,color: color_blue,),
          suffixIcon: const Padding(
            padding:  EdgeInsets.fromLTRB(0, 0, 4, 0),
          ),
              ),
      ...
      Center(
        child:SizedBox(
          ...
          prefixIcon: const Icon(Icons.lock_rounded, size: 24,color: color_blue,),
          suffixIcon: Padding(
            ...
            child: GestureDetector(
              ...
              child: Icon(
                obscure_
                    ...
                    : Icons.visibility_off_rounded,color: color_blue,
                size: 24,
              ),
            ),
          ),
